...
const Welcome = () => {
    const {user: authUser, canLogin, canRegister, laravelVersion, phpVersion} = usePage().props
        ...
        <div
            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div className="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <svg viewBox="0 0 651 192" fill="none" className="h-16 w-auto text-gray-700 sm:h-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-5 leading-7 font-medium">
                        ...
                        <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div className="flex items-center">
                                <AnnotationIcon className="w-7 h-7 text-gray-500"/>
                                <div className="ml-5 leading-7 font-medium">
                        ...
                        <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div className="flex items-center">
                                <GlobeIcon className="w-7 h-7 text-gray-500"/>
                                <div className="ml-5 leading-7 font-medium text-gray-900 dark:text-white">
                                    Vibrant Ecosystem
                                </div>
                            </div>
                            ...
                            <div className="ml-12">
                                <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <a href="https://nova.laravel.com" className="underline">Nova</a>, and
                ...
                <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div className="text-center text-sm text-gray-500 sm:text-left">
                        <div className="flex items-center">
                            <ShoppingBagIcon className="-mt-px w-5 h-5 text-gray-400"/>

                            <a href="https://laravel.bigcartel.com" className="ml-1 underline">Shop</a>

                            <HeartIcon className="ml-4 -mt-px w-5 h-5 text-gray-400"/>
